...
[![Test](https://github.com/JemZee04/pdfcpu/workflows/Test/badge.svg)](https://github.com/JemZee04/pdfcpu/actions)
[![Coverage Status](https://coveralls.io/repos/github/JemZee04/pdfcpu/badge.svg?branch=master)](https://coveralls.io/github/JemZee04/pdfcpu?branch=master)
[![GoDoc](https://godoc.org/github.com/JemZee04/pdfcpu?status.svg)](https://pkg.go.dev/github.com/JemZee04/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/JemZee04/pdfcpu)](https://goreportcard.com/report/github.com/JemZee04/pdfcpu)
[![Hex.pm](https://img.shields.io/hexpm/l/plug.svg)](https://opensource.org/licenses/Apache-2.0)
[![Latest release](https://img.shields.io/github/release/JemZee04/pdfcpu.svg)](https://github.com/JemZee04/pdfcpu/releases)
...
* [API tests](https://github.com/JemZee04/pdfcpu/tree/master/pkg/api/test)
* [API samples](https://github.com/JemZee04/pdfcpu/tree/master/pkg/samples) 
* CLI usage: `$ pdfcpu help cmd`

### GoDoc

* [pdfcpu package](https://pkg.go.dev/github.com/JemZee04/pdfcpu)
* [pdfcpu API](https://pkg.go.dev/github.com/JemZee04/pdfcpu/pkg/api)
* [pdfcpu CLI](https://pkg.go.dev/github.com/JemZee04/pdfcpu/pkg/cli)
...
### Download
Get the latest binary [here](https://github.com/JemZee04/pdfcpu/releases).


### Using Go Modules

```
$ git clone https://github.com/JemZee04/pdfcpu
...
```
$ go install github.com/JemZee04/pdfcpu/cmd/pdfcpu@latest
```
...
* Please [create](https://github.com/JemZee04/pdfcpu/issues/new/choose) an issue if you find a bug or want to propose a change.
* Feature requests - always welcome!
* Bug fixes - always welcome!
* PRs - let's [discuss](https://github.com/JemZee04/pdfcpu/discussions) first or [create](https://github.com/JemZee04/pdfcpu/issues/new/choose) an issue.
* pdfcpu is stable but still *Alpha* and occasionally undergoing heavy changes.

### How

* The pdfcpu [discussion board](https://github.com/JemZee04/pdfcpu/discussions) is open! Please engage in any form helpful for the community.
